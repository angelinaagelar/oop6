...
public class Human implements Serializable, TreeNode<Human> {
    ...
    private String name;
    private family_tree.human.Gender gender;
    ...
    public Human(String name, family_tree.human.Gender gender, LocalDate birthDate) {
    ...
    public Human(String name, family_tree.human.Gender gender, LocalDate birthDate, Human mother, Human father) {
    ...
    public family_tree.human.Gender getGender() {
        return gender;
    }
